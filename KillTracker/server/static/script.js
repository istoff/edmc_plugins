...
function updateSummaryTables(kill_data) {
  ...
  if (kill_data.shipName != '') {
  updateNestedTable('shipTypeBounties', kill_data.shipName, kill_data.bountyAmount);
  }
	updateNestedTable('eventTypeBounties', kill_data.eventType, kill_data.bountyAmount);
